...
!(function (e, t) {
  ...
  var Q = (function t() {
    ...
    var de,
      ...
      Ae = K,
      Ee = null,
      we = O({}, [].concat(o(M), o(L), o(C), o(F), o(U))),
      xe = null,
      ...
      Ve = null,
      $e = O({}, ["audio", "video", "img", "source", "image", "track"]),
      Xe = null,
      Ze = O({}, [
        "alt",
        "class",
      ...
      ct = function (t) {
        (at && at === t) ||
          ...
          (t = D(t)),
          (de = de =
            -1 === rt.indexOf(t.PARSER_MEDIA_TYPE) ? ot : t.PARSER_MEDIA_TYPE),
          (he =
            "application/xhtml+xml" === de
              ...
              : N),
          (Ee = "ALLOWED_TAGS" in t ? O({}, t.ALLOWED_TAGS, he) : we),
          (xe = "ALLOWED_ATTR" in t ? O({}, t.ALLOWED_ATTR, he) : Se),
          (Xe =
            "ADD_URI_SAFE_ATTR" in t ? O(D(Ze), t.ADD_URI_SAFE_ATTR, he) : Ze),
          (Ve =
            "ADD_DATA_URI_TAGS" in t ? O(D($e), t.ADD_DATA_URI_TAGS, he) : $e),
          (Ye = "FORBID_CONTENTS" in t ? O({}, t.FORBID_CONTENTS, he) : Ke),
          (_e = "FORBID_TAGS" in t ? O({}, t.FORBID_TAGS, he) : {}),
          (Oe = "FORBID_ATTR" in t ? O({}, t.FORBID_ATTR, he) : {}),
          ...
          qe &&
            ((Ee = O({}, o(U))),
            (xe = []),
            !0 === qe.html && (O(Ee, M), O(xe, z)),
            !0 === qe.svg && (O(Ee, L), O(xe, j), O(xe, P)),
            !0 === qe.svgFilters && (O(Ee, C), O(xe, j), O(xe, P)),
            !0 === qe.mathMl && (O(Ee, F), O(xe, B), O(xe, P))),
          t.ADD_TAGS && (Ee === we && (Ee = D(Ee)), O(Ee, t.ADD_TAGS, he)),
          t.ADD_ATTR && (xe === Se && (xe = D(xe)), O(xe, t.ADD_ATTR, he)),
          t.ADD_URI_SAFE_ATTR && O(Xe, t.ADD_URI_SAFE_ATTR, he),
          t.FORBID_CONTENTS &&
            (Ye === Ke && (Ye = D(Ye)), O(Ye, t.FORBID_CONTENTS, he)),
          Ge && (Ee["#text"] = !0),
          Ce && O(Ee, ["html", "head", "body"]),
          Ee.table && (O(Ee, ["tbody"]), delete _e.tbody),
          m && m(t),
          (at = t));
      },
      ut = O({}, ["mi", "mo", "mn", "ms", "mtext"]),
      st = O({}, ["foreignobject", "desc", "title", "annotation-xml"]),
    ...
    var dt = function (e) {
      ...
      At = function (e) {
        ...
        var n = he(e.nodeName);
        if (
          (Nt("uponSanitizeElement", e, { tagName: n, allowedTags: Ee }),
          e.hasChildNodes() &&
      ...
      Et = function (e, t, n) {
        if (je && ("id" === t || "name" === t) && (n in i || n in it))
          return !1;
        if (Re && !Oe[t] && S(be, t));
        else if (De && S(ve, t));
        else if (!xe[t] || Oe[t]) {
      ...
      St = function e(t) {
        ...
        for (Nt("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
          Nt("uponSanitizeShadowNode", n, null),
            At(n) || (n.content instanceof l && e(n.content), xt(n));
    ...
    return (
      (r.sanitize = function (t) {
        ...
        if (
          ((nt = !t) && (t = "\x3c!--\x3e"), "string" != typeof t && !Tt(t))
        ) {
        ...
        if (
          (Ie || ct(f), (r.removed = []), "string" == typeof t && (We = !1), We)
        ) {
          if (t.nodeName) {
            var p = he(t.nodeName);
            if (!Ee[p] || _e[p])
          ...
          (1 ===
            (i = (o = yt("\x3c!----\x3e")).ownerDocument.importNode(t, !0))
              .nodeType &&
            "BODY" === i.nodeName) ||
          "HTML" === i.nodeName
            ? (o = i)
          ...
          if (!He && !Le && !Ce && -1 === t.indexOf("<"))
            return oe && ze ? oe.createHTML(t) : t;
          if (!(o = yt(t))) return He ? null : ze ? ae : "";
        }
        o && Fe && ht(o.firstChild);
        for (var d = bt(We ? t : o); (c = d.nextNode()); )
          (3 === c.nodeType && c === s) ||
            At(c) ||
            (c.content instanceof l && St(c.content), xt(c), (s = c));
        if (((s = null), We)) return t;
        if (He) {
          if (Ue)
            for (m = ue.call(o.ownerDocument); o.firstChild; )
